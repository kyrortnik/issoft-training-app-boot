...
public class TicketController {
    ...
    @Secured({"ROLE_USER","ROLE_ADMIN","ROLE_CINEMA_ADMIN"})
    ...
    public TicketDTO createTicket(@Valid @RequestBody TicketDTO ticketDTO, Principal currentUser) {
        LOGGER.debug("Entering TicketController.createTicket()");

        TicketDTO createdTicket = this.ticketService.saveTicket(ticketDTO, currentUser);
