...
public class UserService {
    ...
    public UserDTO findUserByLogin(String login) {
        LOGGER.debug("Entering UserService.findUserByLogin()");

        User existingUser = this.userRepository.findByLogin(login)
                .orElseThrow(() -> new UserNotFoundException(String.format(NO_USER_MESSAGE, login)));


        LOGGER.debug("Exiting UserService.findUserByLogin()");
        return this.mapper.toDto(existingUser);
    ...
    public UserDTO registerUser(UserDTO userDTO) {
        ...
        userDTO.getRoles().add(roleService.findByName(ROLE_USER));
